...
# List of all modules
MODULES := colorscheme-generator container-manager filesystem-path-builder logging package-manager pipeline template-renderer wallpaper-effects-processor
