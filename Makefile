...
# List of all modules
MODULES := colorscheme-generator container-manager filesystem-path-builder hyprpaper-manager logging package-manager pipeline socket template-renderer wallpaper-effects-processor
