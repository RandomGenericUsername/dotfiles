...
class PathsConfig(BaseModel):
    ...
    modules_directory: Path = Field(
        default=Path("src/common/modules"),
        description="Directory containing shared modules for container builds",
    )
...
def load_settings() -> Dynaconf:
    ...
    # __file__ is in: .../wallpaper-effects-orchestrator/src/wallpaper_effects_orchestrator/config.py
