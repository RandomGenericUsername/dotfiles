...
class TestFactoryCreate:
    ...
    def test_create_pywal_backend(self, mock_app_config):
        ...
        generator = ColorSchemeGeneratorFactory.create(Backend.PYWAL, mock_app_config)
    ...
    def test_create_wallust_backend(self, mock_app_config):
        ...
        generator = ColorSchemeGeneratorFactory.create(Backend.WALLUST, mock_app_config)
    ...
    def test_create_custom_backend(self, mock_app_config):
        ...
        generator = ColorSchemeGeneratorFactory.create(Backend.CUSTOM, mock_app_config)
...
class TestFactoryListAvailable:
    ...
    def test_list_available_all_backends(self, mock_app_config):
        ...
        with patch.object(WallustGenerator, 'is_available', return_value=True), \
            ...
            available = ColorSchemeGeneratorFactory.list_available(mock_app_config)
