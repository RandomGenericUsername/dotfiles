...
class TestBackendNotAvailableError:
    ...
    def test_backend_not_available_with_reason(self):
        ...
        assert str(error) == "Backend 'pywal' is not available: pywal command not found"
...
class TestTemplateRenderError:
    ...
    def test_template_render_error_basic(self):
        ...
        error = TemplateRenderError("colors.json.j2", "Missing variable 'background'")
        assert error.template == "colors.json.j2"
        assert error.reason == "Missing variable 'background'"
        assert str(error) == "Failed to render template 'colors.json.j2': Missing variable 'background'"
...
class TestOutputWriteError:
    ...
    def test_output_write_error_basic(self):
        ...
        assert str(error) == "Failed to write output file '/path/to/colors.json': Permission denied"
...
class TestInvalidImageError:
    ...
    def test_invalid_image_error_basic(self):
        ...
        assert str(error) == "Invalid image '/path/to/image.png': File not found"
