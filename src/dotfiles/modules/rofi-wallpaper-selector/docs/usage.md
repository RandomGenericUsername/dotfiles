...
The rofi configuration is automatically generated by the rofi-config-manager module at `~/.local/share/dotfiles/dotfiles/config/rofi/wallpaper-selector.rasi`.

To customize the configuration:

1. Edit the rofi-config-manager template at:
   `~/.local/share/dotfiles/.dependencies/modules/rofi-config-manager/src/rofi_config_manager/templates/wallpaper-selector.rasi.j2`

2. Or edit the generated file directly (will be overwritten on next colorscheme change):
   `~/.local/share/dotfiles/dotfiles/config/rofi/wallpaper-selector.rasi`

You can adjust:
- Window size, position, colors
- Grid layout (columns, lines)
- Icon size
- Styling
