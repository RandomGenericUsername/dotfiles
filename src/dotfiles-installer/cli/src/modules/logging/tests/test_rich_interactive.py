...
from src.modules.logging.rich.rich_feature_settings import RichFeatureSettings
...
class TestRichInteractiveFeatures(unittest.TestCase):
    ...
    @patch("cli.modules.logging.rich.rich_logger.RICH_AVAILABLE", True)
    @patch("cli.modules.logging.rich.rich_logger.console_manager")
    @patch("cli.modules.logging.rich.rich_logger.Prompt")
    ...
    @patch("cli.modules.logging.rich.rich_logger.RICH_AVAILABLE", False)
    ...
    @patch("cli.modules.logging.rich.rich_logger.RICH_AVAILABLE", True)
    @patch("cli.modules.logging.rich.rich_logger.console_manager")
    @patch("cli.modules.logging.rich.rich_logger.Confirm")
    ...
    @patch("cli.modules.logging.rich.rich_logger.RICH_AVAILABLE", True)
    @patch("cli.modules.logging.rich.rich_logger.console_manager")
    @patch("cli.modules.logging.rich.rich_logger.Live")
    ...
    @patch("cli.modules.logging.rich.rich_logger.RICH_AVAILABLE", True)
    @patch("cli.modules.logging.rich.rich_logger.console_manager")
    @patch("cli.modules.logging.rich.rich_logger.rich_inspect")
    ...
    def test_rich_unavailable_fallbacks(self):
        ...
        with patch(
            "cli.modules.logging.rich.rich_logger.RICH_AVAILABLE", False
        ):
    ...
    def test_custom_settings_override_defaults(self):
        ...
        with (
            patch("cli.modules.logging.rich.rich_logger.RICH_AVAILABLE", True),
            patch(
                "cli.modules.logging.rich.rich_logger.console_manager"
            ...
            with patch(
                "cli.modules.logging.rich.rich_logger.Prompt"
            ) as mock_prompt:
